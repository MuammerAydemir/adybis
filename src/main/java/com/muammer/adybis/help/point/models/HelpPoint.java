package com.muammer.adybis.help.point.models;
...
public class HelpPoint {
    ...
    @NotNull(message = "Creator id cannot be null or empty!")
    private UUID createdById;

    @Column(name = "name", nullable = false)
    @NotBlank(message = "Help Point name cannot be null or empty!")
    private String name;
